...
nnoremap AS :ALEDetail
nnoremap FF :ALEFix remove_trailing_lines trim_whitespace
nnoremap Q :echo("Q is disabled, becuase it sucks.")
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/ale,~/.vim/plugged/papercolor-theme,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-commentary,~/.vim/plugged/fzf.vim,~/.vim/plugged/editorconfig-vim,~/.vim/plugged/tabular,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/tabular/after,~/.vim/after
set shiftwidth=4
set noshowmode
set smartcase
set smarttab
...
silent only
silent tabonly
cd ~/Projects/hpfp/09_-_lists/exercises/9.12.3_-_writing_your_own_standard_functions.rst.d/standard-functions
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/Lib.hs
badd +80 test/Spec.hs
badd +1 ../../9.12.3_-_writing_your_own_standard_functions.rst
badd +1 package.yaml
argglobal
%argdel
$argadd src/Lib.hs
...
argglobal
terminal ++curwin ++cols=63 ++rows=74 fish
...
wincmd w
argglobal
if bufexists("src/Lib.hs") | buffer src/Lib.hs | else | edit src/Lib.hs | endif
balt test/Spec.hs
setlocal keymap=
setlocal noarabic
setlocal autoindent
